...
export class Utils extends ethereum.SmartContract {
  static bind(address: Address): Utils {
    return new Utils("Utils", address);
  }
  ...
  chainIdToChainSelector(param0: BigInt): BigInt {
    let result = super.call(
      "chainIdToChainSelector",
      "chainIdToChainSelector(uint64):(uint64)",
  ...
  try_chainIdToChainSelector(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "chainIdToChainSelector",
      "chainIdToChainSelector(uint64):(uint64)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  chains(param0: BigInt): Address {
    let result = super.call("chains", "chains(uint64):(address)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
  ...
  try_chains(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("chains", "chains(uint64):(address)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getLinkFees(
    ...
    let result = super.call(
      "getLinkFees",
      "getLinkFees(uint64,uint256,uint256,address):(uint256)",
      [
  ...
  utilCount(): BigInt {
    let result = super.call("utilCount", "utilCount():(uint256)", []);

    return result[0].toBigInt();
  }

  try_utilCount(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("utilCount", "utilCount():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class MintMoreCall extends ethereum.Call {
  get inputs(): MintMoreCall__Inputs {
    return new MintMoreCall__Inputs(this);
  }

  get outputs(): MintMoreCall__Outputs {
    return new MintMoreCall__Outputs(this);
  }
}

export class MintMoreCall__Inputs {
  _call: MintMoreCall;

  constructor(call: MintMoreCall) {
    this._call = call;
  }
...
export class MintMoreCall__Outputs {
  _call: MintMoreCall;
...
export class SetChainCall extends ethereum.Call {
  get inputs(): SetChainCall__Inputs {
    return new SetChainCall__Inputs(this);
  }

  get outputs(): SetChainCall__Outputs {
    return new SetChainCall__Outputs(this);
  }
}

export class SetChainCall__Inputs {
  _call: SetChainCall;

  constructor(call: SetChainCall) {
    this._call = call;
  }
...
export class SetChainCall__Outputs {
  _call: SetChainCall;
...
export class SetChainSelectorCall extends ethereum.Call {
  get inputs(): SetChainSelectorCall__Inputs {
    return new SetChainSelectorCall__Inputs(this);
  }

  get outputs(): SetChainSelectorCall__Outputs {
    return new SetChainSelectorCall__Outputs(this);
  }
}

export class SetChainSelectorCall__Inputs {
  _call: SetChainSelectorCall;

  constructor(call: SetChainSelectorCall) {
    this._call = call;
  }
...
export class SetChainSelectorCall__Outputs {
  _call: SetChainSelectorCall;
